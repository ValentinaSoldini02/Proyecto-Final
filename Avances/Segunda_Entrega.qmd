...
detectar_outliers_iqr(datos_2$precio_m2)
...
grafico13 <- ggplot(grupo_piso_1, aes(x = cant_de_piso, y = Cantidad)) +  
  geom_bar(stat = "identity") + 
...
grafico17 <- ggplot(grupo_piso_3, aes(x = apartamentos_por_piso, y = Cantidad)) +  
  geom_bar(stat = "identity") + 
