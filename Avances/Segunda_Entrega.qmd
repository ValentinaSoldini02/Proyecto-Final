...
>>>>>>> 14c87604cfbf91715cab942b483b61eb1e0fbdba
```{r}
...
<<<<<<< HEAD
Pregunta 5) ¿En qué condición se encuentran los alquileres? (Subpregunta de esta: subdividiendo por tipo de alquiler)
...
Pregunta 6) ¿Como se distribuyen las condiciones de las viviendas por municipio?
=======
...
<<<<<<< HEAD
Pregunta 6) ¿Cómo se distribuyen los gastos comunes en relación al municipio, eltipo de propiedad y la condición de la propiedad?

```{r}

# Gráfico 1: Municipio y Gastos Comunes
grafico1 <- ggplot(datos, aes(x = Municipio, y = Gastos_Comunes)) + 
  geom_bar(stat = "identity") + 
  theme(axis.text.x = element_text(size = 6)) +
  labs(title = "Gastos Comunes por Municipio")

# Gráfico 2: Tipo de propiedad y Gastos Comunes
grafico2 <- ggplot(datos, aes(x = tipo_prop, y = Gastos_Comunes)) + 
  geom_bar(stat = "identity") + 
  theme(axis.text.x = element_text(size = 6)) +
  labs(title = "Gastos Comunes por Tipo de Propiedad")

# Gráfico 3: Condición y Gastos Comunes
grafico3 <- ggplot(datos, aes(x = Condicion, y = Gastos_Comunes)) + 
  geom_bar(stat = "identity") + 
  theme(axis.text.x = element_text(size = 6)) +
  labs(title = "Gastos Comunes por Condición")

# Crear la grilla de gráficos
grid.arrange(grafico1, grafico2, grafico3, ncol = 1, nrow = 3)


=======
Pregunta 6) ¿Como se distribuyen los gastos comúnes por Municipio?
```{r}
...
>>>>>>> b552f4e7facc65100f4a28225c2d2ea0ac5a8663
```
...
=======
<<<<<<< HEAD
Pregunta 8) ¿Cómo influye el tipo de alquiler en el nivel de gastos comunes?
=======

Pregunta 7) ¿Cómo influye el tipo de alquiler en el nivel de gastos comunes?
>>>>>>> 14c87604cfbf91715cab942b483b61eb1e0fbdba
...
Pregunta 9) ¿Cómo influye la condición de el alquiler en el nivel de gastos comunes?
...
Pregunta 7) ¿Cómo se distribuyen los Gastos Comunes en relación al tipo de alquiler por Municipio?
=======
Pregunta 10) ¿Cómo se distribuyen los Gastos Comunes en relación al tipo de alquiler por Municipio?
>>>>>>> b552f4e7facc65100f4a28225c2d2ea0ac5a8663
...
=======
Pregunta 11) ¿Cómo se distribuyen los Gastos Comunes en relación a la condición del alquiler por Municipio?
>>>>>>> b552f4e7facc65100f4a28225c2d2ea0ac5a8663
...
Pregunta 9) Cómo influye l tener o no ciertas caracteristicas en el alquiler (como son wifi, una barbacoa o un jardin) en el precio con respecto a los alquileres que no lo tienen?
=======
Pregunta 12) Cómo influye l tener o no ciertas caracteristicas en el alquiler (como son wifi, una barbacoa o un jardin) en el precio con respecto a los alquileres que no lo tienen?
>>>>>>> b552f4e7facc65100f4a28225c2d2ea0ac5a8663
...
Pregunta 13) ¿Cómo cambia el precio según la cantidad de pisos que tiene el inmueble?
...
grupo_piso_1 <- datos %>% # Datos
  ...
  summarise(Cantidad = mean(precio)) # Resumidos por cantidad
grupo_piso_1
...
grafico1 <- ggplot(datos, aes(x = cant_de_piso)) +  
  geom_bar() +
...
grafico2 <- ggplot(grupo_piso_1, aes(x = cant_de_piso, y = Cantidad)) +  
  geom_bar(stat = "identity") + 
...
grafico3 <- ggplot(datos, aes(x = nro_de_piso)) +  
  geom_bar() +
  scale_x_continuous(breaks = unique(datos$nro_de_piso)) +
  labs(title = "Número de piso")

# Gráfico 4: Precio promedio por número de piso
grafico4 <- ggplot(grupo_piso_2, aes(x = nro_de_piso, y = media_precio)) +  
  geom_bar(stat = "identity") + 
  scale_x_continuous(breaks = unique(Prueba12$nro_de_piso)) +
  labs(title = "Precio promedio por número de piso")



# Gráfico 5: Apartamentos por piso
grafico5 <- ggplot(datos, aes(x = apartamentos_por_piso)) + 
  geom_bar() +
...
grafico6 <- ggplot(grupo_piso_3, aes(x = apartamentos_por_piso, y = Cantidad)) +  
  geom_bar(stat = "identity") + 
  scale_x_continuous(breaks = unique(grupo_piso_1$apartamentos_por_piso)) +
...
# Panel 2x3
grid.arrange(grafico1, grafico2, grafico3, grafico4, grafico5, grafico6, ncol = 2, nrow = 3)
...
<<<<<<< HEAD
Pregunta 14) ¿Cómo influye el piso en el precio? Los pisos más altos o más bajos influyen en el precio?
...
# Cantidad
ggplot(datos, aes(x = nro_de_piso)) +  # Datos y ejes
  geom_bar() +
    scale_x_continuous(breaks = datos$nro_de_piso) 
...
Pregunta 15) ¿Cómo influye la cantidad de apartamentos por piso en el precio?
...
# Cantidad
ggplot(datos, aes(x = apartamentos_por_piso)) +# Datos y ejes
   geom_bar() +
    scale_x_continuous(breaks =   datos$nro_de_piso) 
...
<<<<<<< HEAD
Pregunta 16) ¿Cómo influye la cantidad de baños en el precio?
=======




Pregunta 11) ¿Cómo afecta al inmueble el tener cierta cantidad de comodidades como son Baños, Garages, Cuartos y Habitaciones en el precio?

>>>>>>> 14c87604cfbf91715cab942b483b61eb1e0fbdba

```{r}

# Grupos para los gráficos de precios
...
Vemos que en general, lo más común es que los inmuebles tengan un baño, luego el tener 2 o 3 es menos común. Pero vemos que a más baños tenga un inmueble, más alto sera el precio.

Pregunta 17) ¿Cómo influye la cantidad de habitaciones en el precio?
...
Pregunta 18) ¿Cómo influye la cantidad de cuartos en el precio?
...
Vemos que tanto para la cantidad de cuartos y de habitaciones, su distribución es muy parecida, tanto en cantidad como en precio. Donde la cantidad más común de cuartos/habitaciones en los inmuebles para alquilar es de 2 o 3. Y se cumple también que al tener más cantidad de cuartos/habitaciones el precio es más alto.

Pregunta 19) ¿Cómo influye la cantidad de garages en el precio?
...
# GRÁFICOS
grafico1 <- ggplot(datos, aes(x=baños)) + 
  geom_bar() + 
  scale_x_continuous(breaks =  Prueba13$baños)


grafico2 <- ggplot(Prueba13, aes(x=baños, y=media_precio)) + 
  geom_bar(stat="identity") +  
  scale_x_continuous(breaks =  Prueba13$baños)


grafico3 <- ggplot(datos, aes(x=cant_habitaciones)) + 
  geom_bar() +  
  scale_x_continuous(breaks =  Prueba15$cant_habitaciones)


grafico4 <- ggplot(Prueba15, aes(x=cant_habitaciones, y=media_precio)) +  
  geom_bar(stat="identity") +  
  scale_x_continuous(breaks =  Prueba15$cant_habitaciones)


grafico5 <- ggplot(datos, aes(x=cant_cuartos)) + 
  geom_bar() +   
  scale_x_continuous(breaks =  Prueba25$cant_cuartos)


grafico6 <- ggplot(Prueba25, aes(x=cant_cuartos, y=media_precio)) +  
  geom_bar(stat="identity") +   
  scale_x_continuous(breaks =  Prueba25$cant_cuartos)


grafico7 <- ggplot(datos, aes(x=cant_de_est)) + 
  geom_bar() +  
  scale_x_continuous(breaks =  Prueba16$cant_de_est)


grafico8 <- ggplot(Prueba16, aes(x=cant_de_est, y=media_precio)) +  
  geom_bar(stat="identity") +   
  scale_x_continuous(breaks =  Prueba16$cant_de_est)

# Panel 2x4 (dos columnas, 4 filas para 8 gráficos)
grid.arrange(grafico1, grafico2, grafico3, grafico4, grafico5, grafico6, grafico7, grafico8, ncol = 2, nrow=4)
...
Pregunta 12) ¿Existe relación entre los metros cuadrados (por propiedad, tierra o totales) y el precio?
```{r}
...
<<<<<<< HEAD
Pregunta 20) ¿Cómo influyen los metros cuadrados por construcción en el precio?
...
Pregunta 21) ¿Cómo influyen los metros cuadrados por terraza en el precio?
...
Pregunta 22) ¿Cómo influyen los metros cuadrados por tierra en el precio?
...
# Gráfico 1
grafico9 <- ggplot(datos, aes(x=m2_const, y=precio)) +  
  geom_point() + 
  labs(title = "Precio vs. m2 construidos")


# Gráfico 2
grafico10 <- ggplot(datos, aes(x=m2_terraza, y=precio)) +   
  geom_point() + 
  labs(title = "Precio vs. m2 de terraza")


# Gráfico 3
grafico11 <- ggplot(datos, aes(x=m2_totales, y=precio)) +   
  geom_point() + 
...
Pregunta 13) ¿Cómo determina al precio la ubicación de la vivienda (al frente, atrás, al costado, al interior)
```{r}
# "disposicion", "Character", "En que posición se encuentra la propiedad como, interior, frente, fondo"
...
# PRECIO SEGÚN DISPOSICIÓN DEL ALQUILER


Prueba20 <- datos %>%         # Datos
   group_by(disposicion) %>%  # Agrupado por disposicion
   summarise(media_precio = mean(precio)) # Resumido por media del precio
Prueba20
...
ggplot(datos, aes(x=disposicion)) + # Datos y ejes
     geom_bar()# +  # Gráfico de barras
...
ggplot(Prueba20, aes(x=disposicion, y=media_precio)) +  # Datos y ejes
   geom_bar(stat="identity")# +   # Gráfico de barras
 #  scale_x_continuous(breaks =  Prueba20$disposicion) # Elementos del eje X
