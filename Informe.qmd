...
# Crear una tabla con los p-valores
p_values_table <- data.frame(
  Test = c("Shapiro-Wilk", "Jarque-Bera", "Kolmogorov-Smirnov"),
  `P-Valor` = c(shapiro_p_value, jarque_bera_p_value, ks_p_value)
)

r_squared_table <- data.frame(
  `Metric` = c("Shaphiro-Wilk", "Jarque-Bera", "Kolmogorov-Smirnov"),
  `Value` = c())
