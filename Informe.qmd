...
```{r}
names(datos_2)
intrain <- sample(x = 1:nrow(datos_2), size =
nrow(datos_2)*.7)
training <- datos_2[intrain,]
testing <- datos_2[-intrain,]
# ajustamos modelo lineal simple
rf <- randomForest(precio_m2 ~ . -direccion ,data= training)
