...
Como los datos que obtuvimos tenian datos nulos, esto no es lo mejor para hacer una regrecion lineal multiple ya que puede causar problemas en el ajuste del modelo, por esta razon en las diferentes columnas que tenian datos nulos se opto rellenar esos datos con distintos metodos. Como ya se Menciono anteriormente la columna de "precio_m2" se calculó la media de toda la columna y se le asignó este valor a cada fila que no tenía dato.A la columna "direccion" se le asignó el nombre de la zona a la que correspondía la propiedad.A la columna "condición " se le asigno la categoria mas frcuenta y lo mismo sucedio con la columna "disposición"

Dado que la presencia de los valores nulos en los datos pueden afectar negativamente el ajuste y la precisión lineal múltiple, se realizaron varios pasos de limpieza de datos para manejar estos valores faltantes de manera mas adecuada. A continuación, se decriben los métodos utilizados para las diferentes columnas que contiene valores nulos en nuestro conjunto de datos, en la columna de "precio_m2" se calculó la media de toda la columna y se le asignó este valor a cada fila que no tenía dato, en la columna "direccion" se le asignó el nombre de la zona a la que correspondía la propiedad y por último la columna "condición " se le asigno la categoria mas frcuenta y lo mismo sucedio con la columna "disposición"
...
>>>>>>> a00730a012f1e94d8e5c4951d89f815d7062cd4d
