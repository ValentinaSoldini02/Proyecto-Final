...
A continuación se nyetsra un gráfico que ilustra cómo la cantidad de baños afecta el precio por metro cuadrado. Se observe que el precio se incrementa hasta la propiedad que tiene dos baños. Sin embargo, después de dos baños, el impacto en el precio es menor. Es decir, una propiedad con tres baños es mas cara que una con uno, pero es considerablemente más cara que una de dos baños. Parece que llega a un punto en el que la cantidad de baños no afecta el precio por metro cuadrado de una propiedad.
...
ggplot(promedios1, aes(x = baños, y = promedio_precio_m2)) +
  ...
  theme_minimal()
```
De manera similar a lo observado con los baños, el precio por metro cuadrado de la propiedad es mayor cuando la propiedad tiene al menos un estacionamiento.
...
Para esta variable, los valores se recodificaron en cuatro grupos para una mejor interpretación.
