...
ggplot(datos_2, aes(x = cant_de_est, y = mean(precio_m2))) +
  geom_bar(stat = "identity") +
...
ggplot(datos_2, aes(x = calefaccion, y = precio_m2)) +
  geom_bar(stat = "identity") +
  labs(x = "Calefaccion", y = "Precio por m2") + 
  theme_minimal()
```
...
```{r}
media_años <- mean(datos_2$año_de_const[datos_2$año_de_const != 0], na.rm = TRUE)
datos_2$año_de_const[datos_2$año_de_const == 0] <- media_años


ggplot(datos_2, aes(x =año_de_const, y = precio_m2)) +
  geom_point(stat = "identity") +
  labs(x = "Año que fue construido la propiedad", y = "Precio por m2") +
  ggtitle("Precio por m2 según año que fue construida la propiedad") +
  theme_minimal()
...
>>>>>>> a00d0868a725216b86682d4a5a119580427ce1e4
## Modelo Predictivo
